    ...
    <div class="main">
      <div class="section section-basic" id="basic-elements">
        <img src="<?=URL_PATH;?>template/assets/img/path1.png" class="path">
        <div class="container">
      ...
      <div class="section section-navbars">
        <img src="<?=URL_PATH;?>template/assets/img/path3.png" class="path">
      ...
      <div class="section section-pagination">
        <img src="<?=URL_PATH;?>template/assets/img/path4.png" class="path">
        <img src="<?=URL_PATH;?>template/assets/img/path5.png" class="path path1">
        <div class="container">
          <div class="row">
            <div class="col-md-6">
      ...
      <div class="section section-typo">
        <img src="<?=URL_PATH;?>template/assets/img/path1.png" class="path">
        <img src="<?=URL_PATH;?>template/assets/img/path3.png" class="path path1">
        <div class="container">
          ...
          <div id="images">
            ...
            <div class="row">
              <div class="col-sm-3 col-6">
                ...
                <img src="<?=URL_PATH;?>template/assets/img/ryan.jpg" alt="Rounded image" class="img-fluid rounded shadow" style="width: 150px;">
              </div>
              <div class="col-sm-3 col-6">
                <small class="d-block text-uppercase font-weight-bold mb-4">Circle Image</small>
                <img src="<?=URL_PATH;?>template/assets/img/james.jpg" alt="Circle image" class="img-fluid rounded-circle shadow" style="width: 150px;">
              </div>
              <div class="col-sm-3 col-6 mt-5 mt-sm-0">
                <small class="d-block text-uppercase font-weight-bold mb-4">Raised</small>
                <img src="<?=URL_PATH;?>template/assets/img/lora.jpg" alt="Raised image" class="img-fluid rounded shadow-lg" style="width: 150px;">
              </div>
              <div class="col-sm-3 col-6 mt-5 mt-sm-0">
                <small class="d-block text-uppercase font-weight-bold mb-4">Circle Raised</small>
                <img src="<?=URL_PATH;?>template/assets/img/mike.jpg" alt="Raised circle image" class="img-fluid rounded-circle shadow-lg" style="width: 150px;">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="section section-javascript" id="javascriptComponents">
        <img src="<?=URL_PATH;?>template/assets/img/path5.png" class="path">
        <img src="<?=URL_PATH;?>template/assets/img/path5.png" class="path path1">
        <div class="container">
                ...
                <div id="carouselExampleControls" class="carousel slide">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img class="d-block w-100" src="<?=URL_PATH;?>template/assets/img/denys.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src="<?=URL_PATH;?>template/assets/img/fabien-bazanegue.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src="<?=URL_PATH;?>template/assets/img/mark-finn.jpg" alt="Third slide">
                    </div>
                  </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              <a href="examples/landing-page.html">
                <img src="<?=URL_PATH;?>template/assets/img/landing-page.png" alt="Image" class="img-raised">
              </a>
            ...
            <div class="col-sm-6">
              <a href="examples/profile-page.html">
                <img src="<?=URL_PATH;?>template/assets/img/profile-page.png" alt="Image" class="img-raised">
              </a>
        ...
        <div class="container">
          ...
          <div class="row row-grid align-items-center my-md">
            ...
            <div class="col-lg-6 text-lg-center btn-wrapper">
              ...
              <a target="_blank" href="https://github.com/" class="btn btn-icon btn-github btn-round btn-lg" data-toggle="tooltip" data-original-title="Star on Github">
            ...
            <div class="modal-body">
              <div class="btn-wrapper text-center">
                <a href="#" class="btn btn-neutral btn-icon">
                  <img src="<?=URL_PATH;?>template/assets/img/github.svg">
                </a>
                <a href="#" class="btn btn-neutral btn-icon">
                  <img src="<?=URL_PATH;?>template/assets/img/google.svg">
                </a>
              </div>
